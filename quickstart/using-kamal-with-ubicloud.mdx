...
![Create load balancer](/images/quickstart-using-kamal-with-ubicloud-1.png)

- **Add VMs to the Load Balancer:** We need to attach our VMs to the load balancer as shown below.
![Add vms to the load balancer](/images/quickstart-using-kamal-with-ubicloud-2.png)

- **Managed PostgreSQL Database:** Set up a managed PostgreSQL database.
![Create postgreSQL database](/images/quickstart-using-kamal-with-ubicloud-2.png)
